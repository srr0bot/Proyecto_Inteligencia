...
url_busqueda = f'https://api.spoonacular.com/recipes/search?apiKey={api_key}&query={ingredientes_str}&number=1'
...
if response_busqueda.status_code == 200:
    ...
    if data_busqueda['totalResults'] > 0:
        ...
        recipe_id = data_busqueda['results'][0]['id']
        ...
        if response_info_receta.status_code == 200:
            ...
            print("Título:", data_info_receta['title'])
            print("Ingredientes:")
